...
def generate_from_wav(wav_path, model, codec_decoder, dataset_config, decode_config, device):
...
def generate(wav_path: str)->tuple[np.ndarray, int|float]:
    ...
    train_config, model_config, dataset_config, decode_config = config.train_config, config.model_config, config.dataset_config, config.decode_config
    ...
    output_wav = generate_from_wav(wav_path, model, codec_decoder, dataset_config, decode_config, device)
